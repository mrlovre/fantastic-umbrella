...
<museScore version="3.01">
  <Style>
    ...
    <lyricsOddFontFace>SourceSerifPro</lyricsOddFontFace>
    ...
    <lyricsEvenFontFace>SourceSerifPro</lyricsEvenFontFace>
    ...
    <hairpinFontFace>SourceSerifPro</hairpinFontFace>
    ...
    <pedalFontFace>SourceSerifPro</pedalFontFace>
    ...
    <chordSymbolAFontFace>SourceSerifPro</chordSymbolAFontFace>
    ...
    <chordSymbolBFontFace>SourceSerifPro</chordSymbolBFontFace>
    ...
    <nashvilleNumberFontFace>SourceSerifPro</nashvilleNumberFontFace>
    ...
    <voltaFontFace>SourceSerifPro</voltaFontFace>
    ...
    <ottavaFontFace>SourceSerifPro</ottavaFontFace>
    ...
    <tupletFontFace>SourceSerifPro</tupletFontFace>
    ...
    <defaultFontFace>SourceSerifPro</defaultFontFace>
    ...
    <titleFontFace>SourceSerifPro</titleFontFace>
    ...
    <subTitleFontFace>SourceSerifPro</subTitleFontFace>
    ...
    <composerFontFace>SourceSerifPro</composerFontFace>
    ...
    <lyricistFontFace>SourceSerifPro</lyricistFontFace>
    ...
    <fingeringFontFace>SourceSerifPro</fingeringFontFace>
    ...
    <lhGuitarFingeringFontFace>SourceSerifPro</lhGuitarFingeringFontFace>
    ...
    <rhGuitarFingeringFontFace>SourceSerifPro</rhGuitarFingeringFontFace>
    ...
    <stringNumberFontFace>SourceSerifPro</stringNumberFontFace>
    ...
    <longInstrumentFontFace>SourceSerifPro</longInstrumentFontFace>
    ...
    <shortInstrumentFontFace>SourceSerifPro</shortInstrumentFontFace>
    ...
    <partInstrumentFontFace>SourceSerifPro</partInstrumentFontFace>
    ...
    <dynamicsFontFace>SourceSerifPro</dynamicsFontFace>
    ...
    <expressionFontFace>SourceSerifPro</expressionFontFace>
    ...
    <tempoFontFace>SourceSerifPro</tempoFontFace>
    ...
    <metronomeFontFace>SourceSerifPro</metronomeFontFace>
    ...
    <measureNumberFontFace>SourceSerifPro</measureNumberFontFace>
    ...
    <translatorFontFace>SourceSerifPro</translatorFontFace>
    ...
    <systemFontFace>SourceSerifPro</systemFontFace>
    ...
    <staffFontFace>SourceSerifPro</staffFontFace>
    ...
    <rehearsalMarkFontFace>SourceSerifPro</rehearsalMarkFontFace>
    ...
    <repeatLeftFontFace>SourceSerifPro</repeatLeftFontFace>
    ...
    <repeatRightFontFace>SourceSerifPro</repeatRightFontFace>
    ...
    <frameFontFace>SourceSerifPro</frameFontFace>
    ...
    <textLineFontFace>SourceSerifPro</textLineFontFace>
    ...
    <glissandoFontFace>SourceSerifPro</glissandoFontFace>
    ...
    <bendFontFace>SourceSerifPro</bendFontFace>
    ...
    <headerFontFace>SourceSerifPro</headerFontFace>
    ...
    <footerFontFace>SourceSerifPro</footerFontFace>
    ...
    <instrumentChangeFontFace>SourceSerifPro</instrumentChangeFontFace>
    ...
    <stickingFontFace>SourceSerifPro</stickingFontFace>
    ...
    <user1Name></user1Name>
    <user1FontFace>SourceSerifPro</user1FontFace>
    ...
    <user2Name></user2Name>
    <user2FontFace>SourceSerifPro</user2FontFace>
    ...
    <user3Name></user3Name>
    <user3FontFace>SourceSerifPro</user3FontFace>
    ...
    <user4Name></user4Name>
    <user4FontFace>SourceSerifPro</user4FontFace>
    ...
    <user5Name></user5Name>
    <user5FontFace>SourceSerifPro</user5FontFace>
    ...
    <user6Name></user6Name>
    <user6FontFace>SourceSerifPro</user6FontFace>
    ...
    <user7Name></user7Name>
    <user7FontFace>SourceSerifPro</user7FontFace>
    ...
    <user8Name></user8Name>
    <user8FontFace>SourceSerifPro</user8FontFace>
    ...
    <user9Name></user9Name>
    <user9FontFace>SourceSerifPro</user9FontFace>
    ...
    <user10FontFace>SourceSerifPro</user10FontFace>
    ...
    <user11FontFace>SourceSerifPro</user11FontFace>
    ...
    <user12FontFace>SourceSerifPro</user12FontFace>
    ...
    <letRingFontFace>SourceSerifPro</letRingFontFace>
    ...
    <palmMuteFontFace>SourceSerifPro</palmMuteFontFace>
